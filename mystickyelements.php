...
'</style>
	...
	<div class="mysticky-block-icon" style="background-color:' . $mysticky_option ['myfixed_element_icon_bg_color'] . '; background-image: url(' . plugins_url( ''. $mysticky_option ['myfixed_element_icon_bg_img'] . '', __FILE__ ) . ');"></div> 
	 <div class="mysticky-block-content" style="min-height: 50px; color:' . $mysticky_option ['myfixed_element_content_txt_color'] . '; padding: ' . $mysticky_option ['myfixed_element_content_padding'] . 'px;">' . $mysticky_option ['myfixed_element_content'] . '</div>
